...
var DataTable = exports.DataTable = function (_Component) {
    ...
    _createClass(DataTable, [{
        ...
        value: function componentDidUpdate(prevProps, prevState, snapshot) {
            ...
            if (this.props.first !== prevProps.first && this.props.first !== prevState.first) {
                state = { first: this.props.first };
            }
            if (this.props.rows !== prevProps.rows && this.props.rows !== prevState.rows) {
                state = _extends({}, state, { rows: this.props.rows });
            }
            if (this.props.sortField && this.props.sortField !== prevState.sortField) {
                state = _extends({}, state, { sortField: this.props.sortField });
            }
            if (this.props.sortOrder && this.props.sortOrder !== prevState.sortOrder) {
                state = _extends({}, state, { sortOrder: this.props.sortOrder });
            }
            if (this.props.multiSortMeta && this.props.multiSortMeta !== prevState.multiSortMeta) {
                state = _extends({}, state, { multiSortMeta: this.props.multiSortMeta });
            }
            if (this.props.filters && this.props.filters !== prevState.filters) {
                state = _extends({}, state, { filters: this.props.filters });
            }
